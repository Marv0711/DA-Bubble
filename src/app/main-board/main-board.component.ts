...
@Component({
    ...
    imports: [BoardHeaderComponent, WorkspaceMenuComponent, ChannelChatWindowComponent, ThreadWindowComponent, MessageFieldComponent, WorkspaceMenuTogglebarComponent]
})
